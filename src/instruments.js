...
export const INSTRUMENTS = {
  ...
  'electric-piano': {
    name: 'Electric Piano',
    loader: () => new Tone.Sampler({
      // THIS IS THE FIX: This is the correct list of available samples.
      urls: {
        'A1': 'A1.mp3', 'A2': 'A2.mp3',
        'C2': 'C2.mp3', 'C3': 'C3.mp3', 'C4': 'C4.mp3',
        'Ds1': 'Ds1.mp3', 'Ds2': 'Ds2.mp3', 'Ds3': 'Ds3.mp3', 'Ds4': 'Ds4.mp3',
        'Fs1': 'Fs1.mp3', 'Fs2': 'Fs2.mp3', 'Fs3': 'Fs3.mp3', 'Fs4': 'Fs4.mp3'
      },
